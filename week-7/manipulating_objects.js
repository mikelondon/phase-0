...
What tests did you have trouble passing? What did you do to make it pass? Why did that work?
  - at first getting the children carter was the hardest for me to process  because I kept replacing carson with Carter. When I thought of it as ruby and processing a different key, I thought of accesing the new index "carter " = name: "Carter";
How difficult was it to add and delete properties outside of the object itself?
  - I was confuse at first about deleting however I looked up deletion and it seemed pretty straight forward. Adding was described in the answer before.

 What did you learn about manipulating objects in this challenge?
  - I learned that although confusing at first it is pretty similar to manipulating containers in Ruby. They do have their differences but the background logic behind it is somewhat simlar.
*/
